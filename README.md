...
**Jan 2024 – Apr 2024**  
- Created interactive Power BI dashboards to monitor store performance  
- Leveraged Azure blob storage and Python for data ingestion and preprocessing  
- Forecasted sales trends and detected anomalies with Python scripts  
🔧 Tech: Power BI · Python · Azure :contentReference[oaicite:10]{index=10}

### Job Recommendation Web App  
**Dec 2023 – Apr 2024**  
- Built a Streamlit app to suggest jobs via resume upload or skill input  
- Implemented keyword‑based matching, top‑N ranking filters, and dark‑mode UI  
🔧 Tech: Python · Streamlit · Machine Learning :contentReference[oaicite:11]{index=11}
...
- **Narayana Junior College**, Ranga Reddy, TG  
  Intermediate (MPC), Marks: 937 (2020 – 2022) 
...
> **Azure AI Fundamentals (AZ‑900):** Validates foundational knowledge of AI and machine learning services on Microsoft Azure.
...
> **Azure Data Scientist Associate (DP‑100):** Demonstrates ability to design, train, and deploy machine learning models on Azure.  
